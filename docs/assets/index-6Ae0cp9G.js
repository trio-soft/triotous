(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))r(t);new MutationObserver(t=>{for(const s of t)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function i(t){const s={};return t.integrity&&(s.integrity=t.integrity),t.referrerPolicy&&(s.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?s.credentials="include":t.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(t){if(t.ep)return;t.ep=!0;const s=i(t);fetch(t.href,s)}})();/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const le=globalThis,_e=le.ShadowRoot&&(le.ShadyCSS===void 0||le.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ae=Symbol(),Le=new WeakMap;let Je=class{constructor(e,i,r){if(this._$cssResult$=!0,r!==Ae)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=i}get styleSheet(){let e=this.o;const i=this.t;if(_e&&e===void 0){const r=i!==void 0&&i.length===1;r&&(e=Le.get(i)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),r&&Le.set(i,e))}return e}toString(){return this.cssText}};const nt=a=>new Je(typeof a=="string"?a:a+"",void 0,Ae),m=(a,...e)=>{const i=a.length===1?a[0]:e.reduce((r,t,s)=>r+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(t)+a[s+1],a[0]);return new Je(i,a,Ae)},lt=(a,e)=>{if(_e)a.adoptedStyleSheets=e.map(i=>i instanceof CSSStyleSheet?i:i.styleSheet);else for(const i of e){const r=document.createElement("style"),t=le.litNonce;t!==void 0&&r.setAttribute("nonce",t),r.textContent=i.cssText,a.appendChild(r)}},Ze=_e?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let i="";for(const r of e.cssRules)i+=r.cssText;return nt(i)})(a):a;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:ct,defineProperty:pt,getOwnPropertyDescriptor:dt,getOwnPropertyNames:ht,getOwnPropertySymbols:gt,getPrototypeOf:ut}=Object,_=globalThis,Ve=_.trustedTypes,mt=Ve?Ve.emptyScript:"",xe=_.reactiveElementPolyfillSupport,N=(a,e)=>a,ce={toAttribute(a,e){switch(e){case Boolean:a=a?mt:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let i=a;switch(e){case Boolean:i=a!==null;break;case Number:i=a===null?null:Number(a);break;case Object:case Array:try{i=JSON.parse(a)}catch{i=null}}return i}},Se=(a,e)=>!ct(a,e),Be={attribute:!0,type:String,converter:ce,reflect:!1,useDefault:!1,hasChanged:Se};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),_.litPropertyMetadata??(_.litPropertyMetadata=new WeakMap);let I=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??(this.l=[])).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,i=Be){if(i.state&&(i.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((i=Object.create(i)).wrapped=!0),this.elementProperties.set(e,i),!i.noAccessor){const r=Symbol(),t=this.getPropertyDescriptor(e,r,i);t!==void 0&&pt(this.prototype,e,t)}}static getPropertyDescriptor(e,i,r){const{get:t,set:s}=dt(this.prototype,e)??{get(){return this[i]},set(o){this[i]=o}};return{get:t,set(o){const p=t==null?void 0:t.call(this);s==null||s.call(this,o),this.requestUpdate(e,p,r)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Be}static _$Ei(){if(this.hasOwnProperty(N("elementProperties")))return;const e=ut(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(N("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(N("properties"))){const i=this.properties,r=[...ht(i),...gt(i)];for(const t of r)this.createProperty(t,i[t])}const e=this[Symbol.metadata];if(e!==null){const i=litPropertyMetadata.get(e);if(i!==void 0)for(const[r,t]of i)this.elementProperties.set(r,t)}this._$Eh=new Map;for(const[i,r]of this.elementProperties){const t=this._$Eu(i,r);t!==void 0&&this._$Eh.set(t,i)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const i=[];if(Array.isArray(e)){const r=new Set(e.flat(1/0).reverse());for(const t of r)i.unshift(Ze(t))}else e!==void 0&&i.push(Ze(e));return i}static _$Eu(e,i){const r=i.attribute;return r===!1?void 0:typeof r=="string"?r:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var e;this._$ES=new Promise(i=>this.enableUpdating=i),this._$AL=new Map,this._$E_(),this.requestUpdate(),(e=this.constructor.l)==null||e.forEach(i=>i(this))}addController(e){var i;(this._$EO??(this._$EO=new Set)).add(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)==null||i.call(e))}removeController(e){var i;(i=this._$EO)==null||i.delete(e)}_$E_(){const e=new Map,i=this.constructor.elementProperties;for(const r of i.keys())this.hasOwnProperty(r)&&(e.set(r,this[r]),delete this[r]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return lt(e,this.constructor.elementStyles),e}connectedCallback(){var e;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$EO)==null||e.forEach(i=>{var r;return(r=i.hostConnected)==null?void 0:r.call(i)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$EO)==null||e.forEach(i=>{var r;return(r=i.hostDisconnected)==null?void 0:r.call(i)})}attributeChangedCallback(e,i,r){this._$AK(e,r)}_$ET(e,i){var s;const r=this.constructor.elementProperties.get(e),t=this.constructor._$Eu(e,r);if(t!==void 0&&r.reflect===!0){const o=(((s=r.converter)==null?void 0:s.toAttribute)!==void 0?r.converter:ce).toAttribute(i,r.type);this._$Em=e,o==null?this.removeAttribute(t):this.setAttribute(t,o),this._$Em=null}}_$AK(e,i){var s,o;const r=this.constructor,t=r._$Eh.get(e);if(t!==void 0&&this._$Em!==t){const p=r.getPropertyOptions(t),c=typeof p.converter=="function"?{fromAttribute:p.converter}:((s=p.converter)==null?void 0:s.fromAttribute)!==void 0?p.converter:ce;this._$Em=t;const g=c.fromAttribute(i,p.type);this[t]=g??((o=this._$Ej)==null?void 0:o.get(t))??g,this._$Em=null}}requestUpdate(e,i,r,t=!1,s){var o;if(e!==void 0){const p=this.constructor;if(t===!1&&(s=this[e]),r??(r=p.getPropertyOptions(e)),!((r.hasChanged??Se)(s,i)||r.useDefault&&r.reflect&&s===((o=this._$Ej)==null?void 0:o.get(e))&&!this.hasAttribute(p._$Eu(e,r))))return;this.C(e,i,r)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,i,{useDefault:r,reflect:t,wrapped:s},o){r&&!(this._$Ej??(this._$Ej=new Map)).has(e)&&(this._$Ej.set(e,o??i??this[e]),s!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||r||(i=void 0),this._$AL.set(e,i)),t===!0&&this._$Em!==e&&(this._$Eq??(this._$Eq=new Set)).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(i){Promise.reject(i)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var r;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[s,o]of this._$Ep)this[s]=o;this._$Ep=void 0}const t=this.constructor.elementProperties;if(t.size>0)for(const[s,o]of t){const{wrapped:p}=o,c=this[s];p!==!0||this._$AL.has(s)||c===void 0||this.C(s,void 0,o,c)}}let e=!1;const i=this._$AL;try{e=this.shouldUpdate(i),e?(this.willUpdate(i),(r=this._$EO)==null||r.forEach(t=>{var s;return(s=t.hostUpdate)==null?void 0:s.call(t)}),this.update(i)):this._$EM()}catch(t){throw e=!1,this._$EM(),t}e&&this._$AE(i)}willUpdate(e){}_$AE(e){var i;(i=this._$EO)==null||i.forEach(r=>{var t;return(t=r.hostUpdated)==null?void 0:t.call(r)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&(this._$Eq=this._$Eq.forEach(i=>this._$ET(i,this[i]))),this._$EM()}updated(e){}firstUpdated(e){}};I.elementStyles=[],I.shadowRootOptions={mode:"open"},I[N("elementProperties")]=new Map,I[N("finalized")]=new Map,xe==null||xe({ReactiveElement:I}),(_.reactiveElementVersions??(_.reactiveElementVersions=[])).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const W=globalThis,ke=a=>a,pe=W.trustedTypes,Ue=pe?pe.createPolicy("lit-html",{createHTML:a=>a}):void 0,Ke="$lit$",$=`lit$${Math.random().toFixed(9).slice(2)}$`,Qe="?"+$,ft=`<${Qe}>`,C=document,G=()=>C.createComment(""),q=a=>a===null||typeof a!="object"&&typeof a!="function",Te=Array.isArray,vt=a=>Te(a)||typeof(a==null?void 0:a[Symbol.iterator])=="function",be=`[ 	
\f\r]`,R=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Re=/-->/g,Ne=/>/g,P=RegExp(`>|${be}(?:([^\\s"'>=/]+)(${be}*=${be}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),We=/'/g,Ge=/"/g,Xe=/^(?:script|style|textarea|title)$/i,xt=a=>(e,...i)=>({_$litType$:a,strings:e,values:i}),l=xt(1),E=Symbol.for("lit-noChange"),u=Symbol.for("lit-nothing"),qe=new WeakMap,j=C.createTreeWalker(C,129);function et(a,e){if(!Te(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ue!==void 0?Ue.createHTML(e):e}const bt=(a,e)=>{const i=a.length-1,r=[];let t,s=e===2?"<svg>":e===3?"<math>":"",o=R;for(let p=0;p<i;p++){const c=a[p];let g,v,d=-1,x=0;for(;x<c.length&&(o.lastIndex=x,v=o.exec(c),v!==null);)x=o.lastIndex,o===R?v[1]==="!--"?o=Re:v[1]!==void 0?o=Ne:v[2]!==void 0?(Xe.test(v[2])&&(t=RegExp("</"+v[2],"g")),o=P):v[3]!==void 0&&(o=P):o===P?v[0]===">"?(o=t??R,d=-1):v[1]===void 0?d=-2:(d=o.lastIndex-v[2].length,g=v[1],o=v[3]===void 0?P:v[3]==='"'?Ge:We):o===Ge||o===We?o=P:o===Re||o===Ne?o=R:(o=P,t=void 0);const w=o===P&&a[p+1].startsWith("/>")?" ":"";s+=o===R?c+ft:d>=0?(r.push(g),c.slice(0,d)+Ke+c.slice(d)+$+w):c+$+(d===-2?p:w)}return[et(a,s+(a[i]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),r]};class F{constructor({strings:e,_$litType$:i},r){let t;this.parts=[];let s=0,o=0;const p=e.length-1,c=this.parts,[g,v]=bt(e,i);if(this.el=F.createElement(g,r),j.currentNode=this.el.content,i===2||i===3){const d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(t=j.nextNode())!==null&&c.length<p;){if(t.nodeType===1){if(t.hasAttributes())for(const d of t.getAttributeNames())if(d.endsWith(Ke)){const x=v[o++],w=t.getAttribute(d).split($),ne=/([.?@])?(.*)/.exec(x);c.push({type:1,index:s,name:ne[2],strings:w,ctor:ne[1]==="."?wt:ne[1]==="?"?$t:ne[1]==="@"?_t:ge}),t.removeAttribute(d)}else d.startsWith($)&&(c.push({type:6,index:s}),t.removeAttribute(d));if(Xe.test(t.tagName)){const d=t.textContent.split($),x=d.length-1;if(x>0){t.textContent=pe?pe.emptyScript:"";for(let w=0;w<x;w++)t.append(d[w],G()),j.nextNode(),c.push({type:2,index:++s});t.append(d[x],G())}}}else if(t.nodeType===8)if(t.data===Qe)c.push({type:2,index:s});else{let d=-1;for(;(d=t.data.indexOf($,d+1))!==-1;)c.push({type:7,index:s}),d+=$.length-1}s++}}static createElement(e,i){const r=C.createElement("template");return r.innerHTML=e,r}}function D(a,e,i=a,r){var o,p;if(e===E)return e;let t=r!==void 0?(o=i._$Co)==null?void 0:o[r]:i._$Cl;const s=q(e)?void 0:e._$litDirective$;return(t==null?void 0:t.constructor)!==s&&((p=t==null?void 0:t._$AO)==null||p.call(t,!1),s===void 0?t=void 0:(t=new s(a),t._$AT(a,i,r)),r!==void 0?(i._$Co??(i._$Co=[]))[r]=t:i._$Cl=t),t!==void 0&&(e=D(a,t._$AS(a,e.values),t,r)),e}class yt{constructor(e,i){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:i},parts:r}=this._$AD,t=((e==null?void 0:e.creationScope)??C).importNode(i,!0);j.currentNode=t;let s=j.nextNode(),o=0,p=0,c=r[0];for(;c!==void 0;){if(o===c.index){let g;c.type===2?g=new re(s,s.nextSibling,this,e):c.type===1?g=new c.ctor(s,c.name,c.strings,this,e):c.type===6&&(g=new At(s,this,e)),this._$AV.push(g),c=r[++p]}o!==(c==null?void 0:c.index)&&(s=j.nextNode(),o++)}return j.currentNode=C,t}p(e){let i=0;for(const r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(e,r,i),i+=r.strings.length-2):r._$AI(e[i])),i++}}class re{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,i,r,t){this.type=2,this._$AH=u,this._$AN=void 0,this._$AA=e,this._$AB=i,this._$AM=r,this.options=t,this._$Cv=(t==null?void 0:t.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=i.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,i=this){e=D(this,e,i),q(e)?e===u||e==null||e===""?(this._$AH!==u&&this._$AR(),this._$AH=u):e!==this._$AH&&e!==E&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):vt(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==u&&q(this._$AH)?this._$AA.nextSibling.data=e:this.T(C.createTextNode(e)),this._$AH=e}$(e){var s;const{values:i,_$litType$:r}=e,t=typeof r=="number"?this._$AC(e):(r.el===void 0&&(r.el=F.createElement(et(r.h,r.h[0]),this.options)),r);if(((s=this._$AH)==null?void 0:s._$AD)===t)this._$AH.p(i);else{const o=new yt(t,this),p=o.u(this.options);o.p(i),this.T(p),this._$AH=o}}_$AC(e){let i=qe.get(e.strings);return i===void 0&&qe.set(e.strings,i=new F(e)),i}k(e){Te(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let r,t=0;for(const s of e)t===i.length?i.push(r=new re(this.O(G()),this.O(G()),this,this.options)):r=i[t],r._$AI(s),t++;t<i.length&&(this._$AR(r&&r._$AB.nextSibling,t),i.length=t)}_$AR(e=this._$AA.nextSibling,i){var r;for((r=this._$AP)==null?void 0:r.call(this,!1,!0,i);e!==this._$AB;){const t=ke(e).nextSibling;ke(e).remove(),e=t}}setConnected(e){var i;this._$AM===void 0&&(this._$Cv=e,(i=this._$AP)==null||i.call(this,e))}}class ge{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,i,r,t,s){this.type=1,this._$AH=u,this._$AN=void 0,this.element=e,this.name=i,this._$AM=t,this.options=s,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=u}_$AI(e,i=this,r,t){const s=this.strings;let o=!1;if(s===void 0)e=D(this,e,i,0),o=!q(e)||e!==this._$AH&&e!==E,o&&(this._$AH=e);else{const p=e;let c,g;for(e=s[0],c=0;c<s.length-1;c++)g=D(this,p[r+c],i,c),g===E&&(g=this._$AH[c]),o||(o=!q(g)||g!==this._$AH[c]),g===u?e=u:e!==u&&(e+=(g??"")+s[c+1]),this._$AH[c]=g}o&&!t&&this.j(e)}j(e){e===u?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class wt extends ge{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===u?void 0:e}}class $t extends ge{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==u)}}class _t extends ge{constructor(e,i,r,t,s){super(e,i,r,t,s),this.type=5}_$AI(e,i=this){if((e=D(this,e,i,0)??u)===E)return;const r=this._$AH,t=e===u&&r!==u||e.capture!==r.capture||e.once!==r.once||e.passive!==r.passive,s=e!==u&&(r===u||t);t&&this.element.removeEventListener(this.name,this,r),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var i;typeof this._$AH=="function"?this._$AH.call(((i=this.options)==null?void 0:i.host)??this.element,e):this._$AH.handleEvent(e)}}class At{constructor(e,i,r){this.element=e,this.type=6,this._$AN=void 0,this._$AM=i,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(e){D(this,e)}}const ye=W.litHtmlPolyfillSupport;ye==null||ye(F,re),(W.litHtmlVersions??(W.litHtmlVersions=[])).push("3.3.2");const St=(a,e,i)=>{const r=(i==null?void 0:i.renderBefore)??e;let t=r._$litPart$;if(t===void 0){const s=(i==null?void 0:i.renderBefore)??null;r._$litPart$=t=new re(e.insertBefore(G(),s),s,void 0,i??{})}return t._$AI(a),t};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const O=globalThis;let h=class extends I{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var i;const e=super.createRenderRoot();return(i=this.renderOptions).renderBefore??(i.renderBefore=e.firstChild),e}update(e){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=St(i,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return E}};var Ye;h._$litElement$=!0,h.finalized=!0,(Ye=O.litElementHydrateSupport)==null||Ye.call(O,{LitElement:h});const we=O.litElementPolyfillSupport;we==null||we({LitElement:h});(O.litElementVersions??(O.litElementVersions=[])).push("4.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Tt={attribute:!0,type:String,converter:ce,reflect:!1,hasChanged:Se},Pt=(a=Tt,e,i)=>{const{kind:r,metadata:t}=i;let s=globalThis.litPropertyMetadata.get(t);if(s===void 0&&globalThis.litPropertyMetadata.set(t,s=new Map),r==="setter"&&((a=Object.create(a)).wrapped=!0),s.set(i.name,a),r==="accessor"){const{name:o}=i;return{set(p){const c=e.get.call(this);e.set.call(this,p),this.requestUpdate(o,c,a,!0,p)},init(p){return p!==void 0&&this.C(o,void 0,a,p),p}}}if(r==="setter"){const{name:o}=i;return function(p){const c=this[o];e.call(this,p),this.requestUpdate(o,c,a,!0,p)}}throw Error("Unsupported decorator location: "+r)};function n(a){return(e,i)=>typeof i=="object"?Pt(a,e,i):((r,t,s)=>{const o=t.hasOwnProperty(s);return t.constructor.createProperty(s,r),o?Object.getOwnPropertyDescriptor(t,s):void 0})(a,e,i)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ae(a){return n({...a,state:!0,attribute:!1})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const jt=(a,e,i)=>(i.configurable=!0,i.enumerable=!0,Reflect.decorate&&typeof e!="object"&&Object.defineProperty(a,e,i),i);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Ot(a,e){return(i,r,t)=>{const s=o=>{var p;return((p=o.renderRoot)==null?void 0:p.querySelector(a))??null};return jt(i,r,{get(){return s(this)}})}}const Ct={brand:"Triotous",nav:[{label:"Services",href:"#/services"},{label:"Our Work",href:"#/cases"},{label:"About Us",href:"#/about"},{label:"Contact",href:"#/contact"},{label:"Careers",href:"#/careers"}],getStarted:"Get Started",footer:{privacyPolicy:"Privacy Policy",termsOfService:"Terms of Service",copyright:"© 2025 Triotous. All rights reserved."},privacy:{pageTitle:"Privacy Policy",content:`
 ...
 */class $e extends Mt{constructor(e){if(super(e),this.it=u,e.type!==Ht.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===u||e==null)return this._t=void 0,this.it=e;if(e===E)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const i=[e];return i.raw=i,this._t={_$litType$:this.constructor.resultType,strings:i,values:[]}}}$e.directiveName="unsafeHTML",$e.resultType=1;const b=zt($e),It=`<svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
...
</svg>`,Pe=`<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
...
</svg>`,ue=`<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
...
</svg>`;var Gt=Object.defineProperty,qt=Object.getOwnPropertyDescriptor,se=(a,e,i,r)=>{for(var t=r>1?void 0:r?qt(e,i):e,s=a.length-1,o;s>=0;s--)(o=a[s])&&(t=(r?o(e,i,t):o(t))||t);return r&&t&&Gt(e,i,t),t};let H=class extends h{constructor(){super(...arguments),this.lang="en",this.theme="dark",this.data={brand:"Triotous",nav:[],getStarted:"Get Started"},this._menuOpen=!1,this._toggleTheme=()=>{const a=this.getRootNode().host;if(!a)return;const e=a.theme==="dark"?"light":"dark";a.theme=e;try{window.localStorage.setItem("triotous-theme",e)}catch{}}}_toggleMenu(){this._menuOpen=!this._menuOpen}_closeMenu(){this._menuOpen=!1}render(){const a="#/language",e=this.lang==="jp"?"#/jp/":"#/",i=this.theme==="dark"?this.lang==="jp"?"ライト":"Light":this.lang==="jp"?"ダーク":"Dark",r=this.theme==="dark"?this.lang==="jp"?"ライトテーマに切り替え":"Switch to light theme":this.lang==="jp"?"ダークテーマに切り替え":"Switch to dark theme",t=this.theme==="dark"?"☀":"☾";return l`
      <header class="header">
        ...
        <div class="header-right">
          <nav class="header-nav">
            ${this.data.nav.map(s=>l`<a class="header-nav-link" href="${s.href}">${s.label}</a>`)}
          </nav>
          <div class="header-actions">
            <button
              ...
              aria-label=${r}
            >
              <span class="theme-icon" aria-hidden="true">${t}</span>
              <span>${i}</span>
            </button>
            <a class="header-lang-btn" href="${a}" title="Change language">${b(It)}</a>
          </div>
          <button class="hamburger" @click=${this._toggleMenu} aria-label="Toggle menu">☰</button>
        </div>
        <nav class="mobile-nav" ?hidden=${!this._menuOpen}>
          ${this.data.nav.map(s=>l`<a class="mobile-nav-link" href="${s.href}" @click=${this._closeMenu}>${s.label}</a>`)}
        </nav>
      </header>
    `}};H.styles=m`
    :host { display: block; }
  ...
  `;se([n({type:String})],H.prototype,"lang",2);se([n({type:String})],H.prototype,"theme",2);se([n({type:Object})],H.prototype,"data",2);se([ae()],H.prototype,"_menuOpen",2);H=se([f("trio-header")],H);var Ft=Object.defineProperty,Yt=Object.getOwnPropertyDescriptor,Oe=(a,e,i,r)=>{for(var t=r>1?void 0:r?Yt(e,i):e,s=a.length-1,o;s>=0;s--)(o=a[s])&&(t=(r?o(e,i,t):o(t))||t);return r&&t&&Ft(e,i,t),t};let Y=class extends h{constructor(){super(...arguments),this.lang="en",this.data={privacyPolicy:"Privacy Policy",termsOfService:"Terms of Service",copyright:"© 2025 Triotous. All rights reserved."}}render(){const a=this.lang==="jp"?"#/jp/privacy":"#/privacy",e=this.lang==="jp"?"#/jp/terms":"#/terms";return l`
  ...
  `;Oe([n({type:String})],Y.prototype,"lang",2);Oe([n({type:Object})],Y.prototype,"data",2);Y=Oe([f("trio-footer")],Y);var Jt=Object.defineProperty,Kt=Object.getOwnPropertyDescriptor,B=(a,e,i,r)=>{for(var t=r>1?void 0:r?Kt(e,i):e,s=a.length-1,o;s>=0;s--)(o=a[s])&&(t=(r?o(e,i,t):o(t))||t);return r&&t&&Jt(e,i,t),t};let A=class extends h{constructor(){super(...arguments),this.title="",this.subtitle="",this.buttonText="",this.buttonHref="",this.backgroundImage="/hero-en.jpg"}render(){return l`
  ...
  `;B([n({type:String})],A.prototype,"title",2);B([n({type:String})],A.prototype,"subtitle",2);B([n({type:String})],A.prototype,"buttonText",2);B([n({type:String})],A.prototype,"buttonHref",2);B([n({type:String})],A.prototype,"backgroundImage",2);A=B([f("trio-hero")],A);var Qt=Object.defineProperty,Xt=Object.getOwnPropertyDescriptor,me=(a,e,i,r)=>{for(var t=r>1?void 0:r?Xt(e,i):e,s=a.length-1,o;s>=0;s--)(o=a[s])&&(t=(r?o(e,i,t):o(t))||t);return r&&t&&Qt(e,i,t),t};const Fe={gear:tt,"app-window":Dt,robot:it,"presentation-chart":Lt,cloud:Zt,lightbulb:Pe,globe:rt,"device-mobile":Vt,code:Bt,video:kt,"chart-line":Ut,headset:Rt,users:ue,briefcase:Nt,"list-checks":Wt,user:at,rocket:je};function ei(a){return Fe[a]||Fe.gear}let L=class extends h{constructor(){super(...arguments),this.icon="gear",this.title="",this.description=""}render(){return l`
      <div class="service-card">
        <div class="service-card-icon">${b(ei(this.icon))}</div>
  ...
  `;me([n({type:String})],L.prototype,"icon",2);me([n({type:String})],L.prototype,"title",2);me([n({type:String})],L.prototype,"description",2);L=me([f("trio-service-card")],L);var ti=Object.defineProperty,ii=Object.getOwnPropertyDescriptor,st=(a,e,i,r)=>{for(var t=r>1?void 0:r?ii(e,i):e,s=a.length-1,o;s>=0;s--)(o=a[s])&&(t=(r?o(e,i,t):o(t))||t);return r&&t&&ti(e,i,t),t};let de=class extends h{constructor(){super(...arguments),this.services=[]}render(){return l`
      <div class="service-grid">
        ${this.services.map(a=>l`
          <trio-service-card
            .icon="${a.icon}"
            .title="${a.title}"
  ...
  `;st([n({type:Array})],de.prototype,"services",2);de=st([f("trio-service-grid")],de);var ri=Object.defineProperty,ai=Object.getOwnPropertyDescriptor,M=(a,e,i,r)=>{for(var t=r>1?void 0:r?ai(e,i):e,s=a.length-1,o;s>=0;s--)(o=a[s])&&(t=(r?o(e,i,t):o(t))||t);return r&&t&&ri(e,i,t),t};let y=class extends h{constructor(){super(...arguments),this.image="",this.title="",this.description="",this.client="",this.horizontal=!1,this.lang="en"}render(){const a=this.lang==="jp"?"#/jp/cases":"#/cases";return l`
  ...
  `;M([n({type:String})],y.prototype,"image",2);M([n({type:String})],y.prototype,"title",2);M([n({type:String})],y.prototype,"description",2);M([n({type:String})],y.prototype,"client",2);M([n({type:Boolean})],y.prototype,"horizontal",2);M([n({type:String})],y.prototype,"lang",2);y=M([f("trio-case-card")],y);var si=Object.defineProperty,oi=Object.getOwnPropertyDescriptor,fe=(a,e,i,r)=>{for(var t=r>1?void 0:r?oi(e,i):e,s=a.length-1,o;s>=0;s--)(o=a[s])&&(t=(r?o(e,i,t):o(t))||t);return r&&t&&si(e,i,t),t};let Z=class extends h{constructor(){super(...arguments),this.cases=[],this.scrollable=!1,this.lang="en"}render(){const a=!this.scrollable,e=this.scrollable?"case-list-scrollable":"case-list-vertical";return l`
      <div class="${e}">
  ...
  `;fe([n({type:Array})],Z.prototype,"cases",2);fe([n({type:Boolean})],Z.prototype,"scrollable",2);fe([n({type:String})],Z.prototype,"lang",2);Z=fe([f("trio-case-list")],Z);var ni=Object.defineProperty,li=Object.getOwnPropertyDescriptor,oe=(a,e,i,r)=>{for(var t=r>1?void 0:r?li(e,i):e,s=a.length-1,o;s>=0;s--)(o=a[s])&&(t=(r?o(e,i,t):o(t))||t);return r&&t&&ni(e,i,t),t};let z=class extends h{constructor(){super(...arguments),this.category="",this.title="",this.description="",this.image=""}render(){return l`<div class="news-item"><div class="news-item-text"><p class="news-item-category">${this.category}</p><p class="news-item-title">${this.title}</p><p class="news-item-description">${this.description}</p></div><div class="news-item-image-wrap"><img class="news-item-image" src="${this.image}" alt="${this.title}" /></div></div>`}};z.styles=m`
    :host { display: block; }
    .news-item {
  ...
  `;oe([n({type:String})],z.prototype,"category",2);oe([n({type:String})],z.prototype,"title",2);oe([n({type:String})],z.prototype,"description",2);oe([n({type:String})],z.prototype,"image",2);z=oe([f("trio-news-item")],z);var ci=Object.defineProperty,pi=Object.getOwnPropertyDescriptor,k=(a,e,i,r)=>{for(var t=r>1?void 0:r?pi(e,i):e,s=a.length-1,o;s>=0;s--)(o=a[s])&&(t=(r?o(e,i,t):o(t))||t);return r&&t&&ci(e,i,t),t};let S=class extends h{constructor(){super(...arguments),this.title="",this.subtitle="",this.buttonText="",this.buttonHref="",this.lang="en"}render(){const a=this.buttonHref||(this.lang==="jp"?"#/jp/contact":"#/contact");return l`
      <div class="cta-wrap">
        <div class="cta-box">
          <div class="cta-text">
  ...
  `;k([n({type:String})],S.prototype,"title",2);k([n({type:String})],S.prototype,"subtitle",2);k([n({type:String})],S.prototype,"buttonText",2);k([n({type:String})],S.prototype,"buttonHref",2);k([n({type:String})],S.prototype,"lang",2);S=k([f("trio-cta-section")],S);var di=Object.defineProperty,hi=Object.getOwnPropertyDescriptor,Ce=(a,e,i,r)=>{for(var t=r>1?void 0:r?hi(e,i):e,s=a.length-1,o;s>=0;s--)(o=a[s])&&(t=(r?o(e,i,t):o(t))||t);return r&&t&&di(e,i,t),t};let J=class extends h{constructor(){super(...arguments),this.data={},this.lang="en"}render(){const a=this.data;if(!a)return l`<div>Loading...</div>`;const e=this.lang==="jp"?"#/jp/services":"#/services",i=this.lang==="jp"?"#/jp/contact":"#/contact",r=this.lang==="jp"?"/hero-jp.jpg":"/hero-en.jpg";return l`
      <trio-hero .title=${a.heroTitle} .subtitle=${a.heroSubtitle} .buttonText=${a.heroButton} .buttonHref=${e} .backgroundImage=${r}></trio-hero>
      ...
      <div class="news-list">${a.news.map(t=>l`<trio-news-item .category=${t.category} .title=${t.title} .description=${t.description} .image=${t.image}></trio-news-item>`)}</div>
  ...
  `;Ce([n({type:Object})],J.prototype,"data",2);Ce([n({type:String})],J.prototype,"lang",2);J=Ce([f("page-home")],J);var gi=Object.defineProperty,ui=Object.getOwnPropertyDescriptor,Ee=(a,e,i,r)=>{for(var t=r>1?void 0:r?ui(e,i):e,s=a.length-1,o;s>=0;s--)(o=a[s])&&(t=(r?o(e,i,t):o(t))||t);return r&&t&&gi(e,i,t),t};let K=class extends h{constructor(){super(...arguments),this.data={},this.lang="en"}render(){const a=this.data;if(!a)return l`<div>Loading...</div>`;const e=this.lang==="jp"?"#/jp/contact":"#/contact";return l`<div class="page-head"><div class="page-head-box"><p class="page-title">${a.pageTitle}</p><p class="page-subtitle">${a.pageSubtitle}</p></div></div>${a.sections.map(i=>l`<h2 class="section-title">${i.title}</h2><div class="grid-wrap"><trio-service-grid .services=${i.cards}></trio-service-grid></div>`)}<trio-cta-section .title=${a.ctaTitle} .subtitle=${a.ctaSubtitle} .buttonText=${a.ctaButton} .buttonHref=${e} tone="blue"></trio-cta-section>`}};K.styles=m`
    :host { display: block; }
  ...
  `;Ee([n({type:Object})],K.prototype,"data",2);Ee([n({type:String})],K.prototype,"lang",2);K=Ee([f("page-services")],K);var mi=Object.defineProperty,fi=Object.getOwnPropertyDescriptor,He=(a,e,i,r)=>{for(var t=r>1?void 0:r?fi(e,i):e,s=a.length-1,o;s>=0;s--)(o=a[s])&&(t=(r?o(e,i,t):o(t))||t);return r&&t&&mi(e,i,t),t};let Q=class extends h{constructor(){super(...arguments),this.lang="en",this.data={}}render(){return l`
      <div class="container">
  ...
  `;He([n({type:String})],Q.prototype,"lang",2);He([n({type:Object})],Q.prototype,"data",2);Q=He([f("page-cases")],Q);var vi=Object.defineProperty,xi=Object.getOwnPropertyDescriptor,ze=(a,e,i,r)=>{for(var t=r>1?void 0:r?xi(e,i):e,s=a.length-1,o;s>=0;s--)(o=a[s])&&(t=(r?o(e,i,t):o(t))||t);return r&&t&&vi(e,i,t),t};let X=class extends h{constructor(){super(...arguments),this.lang="en",this.data={}}render(){return l`
      <div class="container">
        <div class="header-section">
          <h1 class="page-title">${this.data.pageTitle}</h1>
        </div>
        ...
        <div class="grid">
          ${this.data.team.map(a=>l`
            <div class="card ${a.isAI?"card--ai":""}">
              <div class="card-icon ${a.isAI?"card-icon--ai":""}">${b(a.isAI?it:at)}</div>
              <div class="title-group">
                <h3 class="card-title">${a.name}</h3>
                <p class="card-desc">${a.role}</p>
                ${a.isAI?l`<span class="badge">Digital Employee</span>`:""}
              </div>
            </div>
          `)}
        </div>
        ...
        <div class="grid">
          ${this.data.values.map(a=>l`
            <div class="card">
              <div class="card-icon">
                <!-- Simple mapping for icons -->
                ${a.icon==="lightbulb"?b(Pe):""}
                ${a.icon==="users"?b(ue):""}
                ${a.icon==="rocket"?b(je):""}
              </div>
              <div class="title-group">
  ...
  `;ze([n({type:String})],X.prototype,"lang",2);ze([n({type:Object})],X.prototype,"data",2);X=ze([f("page-about")],X);var bi=Object.defineProperty,yi=Object.getOwnPropertyDescriptor,U=(a,e,i,r)=>{for(var t=r>1?void 0:r?yi(e,i):e,s=a.length-1,o;s>=0;s--)(o=a[s])&&(t=(r?o(e,i,t):o(t))||t);return r&&t&&bi(e,i,t),t};const wi="https://formspree.io/f/mreyloqo";let T=class extends h{constructor(){super(...arguments),this.lang="en",this.data={},this._status="idle",this._errorMessage=""}async _handleSubmit(a){a.preventDefault(),this._status="submitting",this._errorMessage="";const e=new FormData(this._form);try{const i=await fetch(wi,{method:"POST",body:e,headers:{Accept:"application/json"}});if(i.ok)this._status="success",this._form.reset();else{const r=await i.json();r.errors?this._errorMessage=r.errors.map(t=>t.message).join(", "):this._errorMessage=this.lang==="jp"?"フォームの送信中に問題が発生しました。":"Oops! There was a problem submitting your form.",this._status="error"}}catch{this._errorMessage=this.lang==="jp"?"フォームの送信中に問題が発生しました。":"Oops! There was a problem submitting your form.",this._status="error"}}_renderStatusMessage(){if(this._status==="success"){const a=this.lang==="jp"?"お問い合わせありがとうございます！":"Thanks for your submission!";return l`<p class="status-message status-success">${a}</p>`}return this._status==="error"?l`<p class="status-message status-error">${this._errorMessage}</p>`:""}render(){const a=this._status==="submitting";return l`
      <div class="container">
        <div class="header-section">
          <div class="title-group">
            <h1 class="page-title">${this.data.pageTitle}</h1>
  ...
  `;U([n({type:String})],T.prototype,"lang",2);U([n({type:Object})],T.prototype,"data",2);U([ae()],T.prototype,"_status",2);U([ae()],T.prototype,"_errorMessage",2);U([Ot("form")],T.prototype,"_form",2);T=U([f("page-contact")],T);var $i=Object.defineProperty,_i=Object.getOwnPropertyDescriptor,Me=(a,e,i,r)=>{for(var t=r>1?void 0:r?_i(e,i):e,s=a.length-1,o;s>=0;s--)(o=a[s])&&(t=(r?o(e,i,t):o(t))||t);return r&&t&&$i(e,i,t),t};let ee=class extends h{constructor(){super(...arguments),this.lang="en",this.data={}}render(){return l`
      <div class="container">
        <h1 class="page-title">${this.data.pageTitle}</h1>
        <div class="content">
          ${b(this.data.content)}
  ...
  `;Me([n({type:String})],ee.prototype,"lang",2);Me([n({type:Object})],ee.prototype,"data",2);ee=Me([f("page-privacy")],ee);var Ai=Object.defineProperty,Si=Object.getOwnPropertyDescriptor,Ie=(a,e,i,r)=>{for(var t=r>1?void 0:r?Si(e,i):e,s=a.length-1,o;s>=0;s--)(o=a[s])&&(t=(r?o(e,i,t):o(t))||t);return r&&t&&Ai(e,i,t),t};let te=class extends h{constructor(){super(...arguments),this.lang="en",this.data={}}render(){return l`
      <div class="container">
        <h1 class="page-title">${this.data.pageTitle}</h1>
        <div class="content">
          ${b(this.data.content)}
  ...
  `;Ie([n({type:String})],te.prototype,"lang",2);Ie([n({type:Object})],te.prototype,"data",2);te=Ie([f("page-terms")],te);var Ti=Object.defineProperty,Pi=Object.getOwnPropertyDescriptor,De=(a,e,i,r)=>{for(var t=r>1?void 0:r?Pi(e,i):e,s=a.length-1,o;s>=0;s--)(o=a[s])&&(t=(r?o(e,i,t):o(t))||t);return r&&t&&Ti(e,i,t),t};const ji={users:ue,rocket:je,lightbulb:Pe,gear:tt,globe:rt};let ie=class extends h{constructor(){super(...arguments),this.lang="en",this.data={}}render(){var a,e;return l`
      <div class="container">
        <h1 class="page-title">${this.data.pageTitle}</h1>
        ...
        <div class="values-grid">
          ${(a=this.data.values)==null?void 0:a.map(i=>l`
            <div class="value-card">
              <div class="value-icon">${b(ji[i.icon]||ue)}</div>
              <h3 class="value-title">${i.title}</h3>
              <p class="value-desc">${i.description}</p>
            </div>
          `)}
        </div>
        ...
        <ul class="culture-list">
          ${(e=this.data.cultureItems)==null?void 0:e.map(i=>l`<li>${i}</li>`)}
        </ul>
  ...
  `;De([n({type:String})],ie.prototype,"lang",2);De([n({type:Object})],ie.prototype,"data",2);ie=De([f("page-careers")],ie);var Oi=Object.defineProperty,Ci=Object.getOwnPropertyDescriptor,ot=(a,e,i,r)=>{for(var t=r>1?void 0:r?Ci(e,i):e,s=a.length-1,o;s>=0;s--)(o=a[s])&&(t=(r?o(e,i,t):o(t))||t);return r&&t&&Oi(e,i,t),t};let he=class extends h{constructor(){super(...arguments),this.data={}}render(){return l`
      <div class="wrapper">
        <div class="content">
          <div class="header">
  ...
  `;ot([n({type:Object})],he.prototype,"data",2);he=ot([f("trio-language-selector")],he);var Ei=Object.defineProperty,Hi=Object.getOwnPropertyDescriptor,ve=(a,e,i,r)=>{for(var t=r>1?void 0:r?Hi(e,i):e,s=a.length-1,o;s>=0;s--)(o=a[s])&&(t=(r?o(e,i,t):o(t))||t);return r&&t&&Ei(e,i,t),t};let V=class extends h{constructor(){super(),this.theme=this._getInitialTheme(),this.route=window.location.hash||"#/",this.lang=this.route.startsWith("#/jp")?"jp":"en",this._handleThemeToggle=()=>{this.theme=this.theme==="dark"?"light":"dark";try{window.localStorage.setItem("triotous-theme",this.theme)}catch{}},this._syncDocumentTheme(),window.addEventListener("hashchange",()=>{this.route=window.location.hash||"#/",this.lang=this.route.startsWith("#/jp")?"jp":"en",window.scrollTo(0,0)})}updated(a){a.has("theme")&&this._syncDocumentTheme()}_getInitialTheme(){try{return window.localStorage.getItem("triotous-theme")??"dark"}catch{return"dark"}}_syncDocumentTheme(){document.documentElement.style.colorScheme=this.theme,document.body.style.backgroundColor=getComputedStyle(this).getPropertyValue("--app-bg").trim()||""}render(){const a=this.lang==="jp"?Et:Ct;return l`
      <div class="app-container">
        ${this.route==="#/language"?l`<trio-language-selector .data=${a.language}></trio-language-selector>`:l`
            <trio-header .lang=${this.lang} .data=${a} .theme=${this.theme}></trio-header>
            <main>
              ${this.renderPage(a)}
            </main>
    ...
    `}renderPage(a){switch(this.lang==="jp"?this.route.replace("#/jp","")||"/":this.route.replace("#","")||"/"){case"/":return l`<page-home .lang=${this.lang} .data=${a.home}></page-home>`;case"/services":return l`<page-services .lang=${this.lang} .data=${a.services}></page-services>`;case"/cases":return l`<page-cases .lang=${this.lang} .data=${a.cases}></page-cases>`;case"/about":return l`<page-about .lang=${this.lang} .data=${a.about}></page-about>`;case"/contact":return l`<page-contact .lang=${this.lang} .data=${a.contact}></page-contact>`;case"/privacy":return l`<page-privacy .lang=${this.lang} .data=${a.privacy}></page-privacy>`;case"/terms":return l`<page-terms .lang=${this.lang} .data=${a.terms}></page-terms>`;case"/careers":return l`<page-careers .lang=${this.lang} .data=${a.careers}></page-careers>`;default:return l`<page-home .lang=${this.lang} .data=${a.home}></page-home>`}}};V.styles=m`
    :host {
      --app-bg: #f9f9ff;
      --surface: #ffffff;
  ...
  `;ve([n({type:String,reflect:!0})],V.prototype,"theme",2);ve([ae()],V.prototype,"route",2);ve([ae()],V.prototype,"lang",2);V=ve([f("trio-app")],V);
